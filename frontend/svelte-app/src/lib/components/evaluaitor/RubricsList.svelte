...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- Info message for templates tab -->
    {#if activeTab === 'templates'}
        <div class="mx-4 mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-700">
                        {localeLoaded ? $_('rubrics.templatesTabInfo', { default: 'Note: Rubrics you own will not appear in this list, even if they are public. Your own public rubrics can be found in the "My Rubrics" tab.' }) : 'Note: Rubrics you own will not appear in this list, even if they are public. Your own public rubrics can be found in the "My Rubrics" tab.'}
                    </p>
                </div>
            </div>
        </div>
