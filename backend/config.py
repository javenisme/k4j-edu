...
MAIN_LOG_LEVEL = os.getenv('MAIN_LOG_LEVEL', GLOBAL_LOG_LEVEL)
API_LOG_LEVEL = os.getenv('API_LOG_LEVEL', GLOBAL_LOG_LEVEL)
DB_LOG_LEVEL = os.getenv('DB_LOG_LEVEL', GLOBAL_LOG_LEVEL)
RAG_LOG_LEVEL = os.getenv('RAG_LOG_LEVEL', GLOBAL_LOG_LEVEL)
EVALUATOR_LOG_LEVEL = os.getenv('EVALUATOR_LOG_LEVEL', GLOBAL_LOG_LEVEL)
OWI_LOG_LEVEL = os.getenv('OWI_LOG_LEVEL', GLOBAL_LOG_LEVEL)
